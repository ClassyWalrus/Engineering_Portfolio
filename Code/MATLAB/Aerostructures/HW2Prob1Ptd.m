Ftilde = [0; 58.33; 80.2; 58.33; -181.77];

Ktilde = [1 0 0 0 0; -.144 .288 -.144 0 0; 0 -.144 .288 -.144 0 ; 0 0 -.144 .288 -.144; 0 0 0 -.144 .144];

U = (10^-6)*(Ktilde\Ftilde)

[U1] = bar_static(5, 1, 120e9, 3e-4, -200000, @(z)(350000*(1-(2*z/L-1)^2)))
